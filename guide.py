...
def ensure_guide_pdf() -> Path:
    ...
    story = [
        ...
        Paragraph("3 · Currencies", heading),
        Paragraph("<b>Cape Credits</b> pay for relic forging and progression. <b>Signal Shards</b> activate Recruitment Beacon pulls. <b>Prism Cores</b> are reserved for premium and special-event systems. <b>Patrol Intel</b> starts Case Files and mission choices. Every balance change is written to the economy ledger.", body),
        ...
        Paragraph("The owner creates all heroes. There are no hardcoded starter heroes. A hero can be marked as the Enhanced, Tech, or Mystic starter during guided creation.", body),
