        ...
        async def register_commands() -> None:
            try:
                await client.set_bot_commands([
                    ...
                    BotCommand("team", "Manage and name your battle teams"),
                    BotCommand("pve", "Fight enemies and villains"),
                    BotCommand("hunt", "Find a random level-matched villain"),
                    BotCommand("pvp", "Enter the player Arena"),
